...
import img4 from "../assets/KAYAK1.jpg";
import img5 from "../assets/KAYAK2.png";
import img6 from "../assets/KAYAK3.jpg";
  ...
  return (
    <div className=" w-full bg-white bg-[url('./assets/placeholder3.png')] bg-contain flex justify-center items-center">
      ...
      <div className="grid grid-cols-6 md:grid-rows-1 grid-rows-8 w-11/12 p-4 my-4 bg-warning  shadow-xl rounded-xl">
        ...
        <div className="md:col-span-4 md:row-span-2 bg-[url('./assets/banner2.png')] bg-center col-span-6 row-span-4 p-4 rounded-xl w-full grid grid-cols-2 grid-rows-2 place-items-stretch gap-2 ">
          <div className="w-full h-full md:h-[260px] ">
            <img className=" w-full h-full rounded-xl" src={img4} alt="" />
          </div>
          <div className="w-full h-full md:h-[260px] ">
            <img className="w-full h-full  rounded-xl" src={img5} alt="" />
          </div>
          <div className="w-full h-full md:h-[260px]  col-span-2">
            <img className=" w-full h-full rounded-xl" src={img6} alt="" />
          </div>
        </div>
